...
class Control_Database {
	...
	public static function create_tables() {
		...
		$queries[] = "CREATE TABLE $table_patients (
			...
			routing_dept varchar(100),
			activation_date datetime,
			parent_account_id bigint(20),
			screening_metadata longtext,
			dob date,
			gender varchar(20),
			...
			id_national_url varchar(255),
			id_residence_url varchar(255),
			id_passport_url varchar(255),
			...
			birth_history text,
			motor_delay varchar(50),
			speech_delay varchar(50),
			sleep_issues varchar(50),
			feeding_issues varchar(50),
			...
			eval_social varchar(50),
			eval_tantrums varchar(50),
			eval_instructions varchar(50),
			eval_activity_level varchar(50),
			eval_independence varchar(50),
			eval_language varchar(50),
			eval_anxiety varchar(50),
			...
			milestones_crawling varchar(255),
			lang_first_word varchar(255),
			lang_sentences varchar(255),
			dev_social_skills text,
			dev_observed_delays text,
			diagnosis_secondary text,
			diagnosis_severity varchar(100),
			tp_goals_short text,
			tp_goals_long text,
			tp_frequency varchar(100),
			bp_target_behaviors text,
			bp_reinforcement_strategies text,
			bp_intervention_techniques text,
			notes_specialist text,
			notes_guardian text,
